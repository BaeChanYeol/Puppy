...
public interface IProductService {
			...
			//리뷰 목록
			List<ReviewVO> getList(PageVO vo, int pno);
			//리뷰 개수
			int getTotal(PageVO vo, int pno); 
			//리뷰 삭제
...
//				
			//상품 수 카운트
			int getpTotal(PageVO vo, String type);
//			
//			int getTotalItems(PageVO vo);
//			
//			int getTotalSnack(PageVO vo);
