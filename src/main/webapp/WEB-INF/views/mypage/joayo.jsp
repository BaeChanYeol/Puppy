<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="mypage clearfix">
        <aside class="side">
            ...
            <ul class="mysidemenu">
                <li>
                    <a href="<c:url value='/reserveBoard/reserveList'/>"> 예약 내역</a>
                </li>
                <li>
                ...
                <li>
                    <a href="<c:url value='/boast/likeList'/>" class="myhover"> <img src="../img/mylikelist.png" alt="구매내역">좋아요 누른글</a>
                </li>
                <li>
			...
			<div id="boast-products">
				...
				<form action="<c:url value='/boast/boastboard' />" name="boastPage">
					<div class="pagination" id="pagination">
						<c:if test="${pc.prev}">
							<button type="button"
								onclick="location.href='/puppy/boast/boastboard?pageNum=${pc.beginPage -1}&countPerPage=${pc.paging.countPerPage}'"
								data-pageNum="${pc.beginPage-1}">&#10094;</button>
						</c:if>
						...
						<c:if test="${pc.next}">
							<button type="button"
								onclick="location.href='/puppy/boast/boastboard?pageNum=${pc.endPage +1}&countPerPage=${pc.paging.countPerPage}'"
								data-pageNum="${pc.endPage+1}">&#10095;</button>
						</c:if>
        		        	  ...
        		        	  $.getJSON("<c:url value='/boast/boastDetail?bbno=' />" + bbno,  
        		        			function(data) {
        								...
        								if(data.boastContent.writer == '${login.id}'){
        										$('.boastdelBtn').css('display', 'block');
        										$('.boastmodBtn').css('display', 'block');
        								}
        	...
        	////////////////////////////댓글
        		          ...
        		          $('.boast-reply-Regist').click(function(e) {
        		             ...
        		             */
        		             ...
        		             if(reply == ''){alert('댓글을 입력해주세요!'); return;}
        		             if(replyId == ''){
