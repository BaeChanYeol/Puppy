        ...
        <div class="joinModal">
            ...
            <div class="joinform">
                <form action="<c:url value='/user/join'/>" method="POST">
                    ...
                    <div class="joinform-email clearfix">
                       <div>
                          <h5><label for="email">이메일</label></h5>
                          <span class="join-check" id="email_check"></span>
                      </div>
                       <input type="text" name="email" id="email" placeholder="이메일을 입력해주세요~">
                       <button type="button" class="mail_check_button">인증번호발송</button>
                       <input type="text" name="email_ok" id="email_ok" placeholder="인증번호를 입력해주세요!">
                       <button type="button" class="mail_ok_button">인증번호확인</button>
                    </div>

                    <h5><label for="phone">휴대전화</label></h5>
                    <span class="join-check" id="phone_check"></span>
